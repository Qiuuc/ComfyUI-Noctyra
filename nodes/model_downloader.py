...
def _ms_download_file(ms_id, rel_path, dest_path, opener):
    ...
    url = f"https://modelscope.cn/api/v1/models/{ms_id}/repo?Revision=master&FilePath={rel_path}"
...
def _models_base():
    """本地落地根目录：ComfyUI/models/Noctyra，取不到则用当前目录。"""
    try:
        import folder_paths
...
def _dest_root(hf_repo, base_override=""):
    ...
    例: stabilityai/stable-diffusion-xl-base-1.0
        -> .../Noctyra/stabilityai__stable-diffusion-xl-base-1.0
    """
...
NODE_DISPLAY_NAME_MAPPINGS = {
    "InvisibleWatermarkModelDownloader": "【隐水印·模型】扩散模型下载器",
}
